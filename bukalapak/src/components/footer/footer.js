      ...
      <div className="ml-5 mr-5 footer">
        <div className="row">
          <div className="col-sm-2">
            <img
              className="imgFooter"
              src="https://s1.bukalapak.com/images/desktop/benefits/jaminan.png"
              alt=""
            />
            <div className="overlay" />
            <h6 className="text-sm-left mt-4">Jaminan 100% Aman</h6>
            <p className="text-sm-left">
              Payment system Bukalapak menjamin keamanan uang Anda dalam
              bertransaksi. Pelajari amannya Bukalapak
            </p>
          </div>
          <div className="col-sm-2">
            <img
              className="imgFooter"
              src="https://s1.bukalapak.com/images/desktop/benefits/bukadompet.png"
              alt=""
            />
            <h6 className="text-sm-left mt-4">Kemudahan Pembayaran</h6>
            <p className="text-sm-left">
              Bukalapak menyediakan berbagai metode pembayaran untuk
              bertransaksi
            </p>
          </div>
          <div className="col-sm-2">
            <img
              className="imgFooter"
              src="https://s1.bukalapak.com/images/desktop/benefits/cs.png"
              alt=""
            />
            <img
              src="https://s1.bukalapak.com/images/desktop/benefits/sq-award.png"
              alt=""
            />
            <h6 className="text-sm-left mt-4">
              Customer Support yang Responsif
            </h6>
            <p className="text-sm-left">
              CS Bukalapak siap membantu Anda melalui e-mail, media sosial dan
              call center (021-5081-3333)
            </p>
          </div>
          <div className="col-sm-2">
            <img
              className="imgFooter"
              src="https://s1.bukalapak.com/images/desktop/benefits/pengiriman.png"
              alt=""
            />
          ...
          <div className="col-sm-2">
            <img
              className="imgFooter"
              src="https://s1.bukalapak.com/images/desktop/benefits/komunitas.png"
              alt=""
            />
          ...
          <div className="col-sm-2">
            <img
              className="imgFooter"
              src="https://s1.bukalapak.com/images/desktop/benefits/apps.png"
              alt=""
            />
            <h6 className="text-sm-left mt-4">Kemudahan Akses Mobile</h6>
            <p className="text-sm-left">
              Download aplikasi Bukalapak di Android dan iOS. Nikmati kemudahan
              jual beli dari gadget Anda
            </p>
          </div>
        </div>
        <hr />
        <div className="row justify-content-between socials">
          <div className="col-sm-8">
            <img
              ...
              src="https://s1.bukalapak.com/images/logo/single_320x51_12_red_03052016.png"
              alt=""
            />{" "}
          ...
          <div className="col-sm-4 text-right">
            <p>
              Temukan kami di :{" "}
              <i
                className="fa fa-facebook-square fa-lg mr-2"
                aria-hidden="true"
              />
              <i
                className="fa fa-twitter-square fa-lg mr-2"
                aria-hidden="true"
              />
              <i class="fa fa-youtube-play fa-lg mr-2" aria-hidden="true" />
              <i class="fa fa-instagram fa-lg mr-2" aria-hidden="true" />
              <i class="fa fa-google-plus fa-lg mr-2" aria-hidden="true" />
              <i class="fa fa-linkedin-square fa-lg mr-2" aria-hidden="true" />
            </p>
          </div>
        </div>
        <hr />
        <div className="row">
          <div className="col-sm-3">
            <input
              type="button"
              className="btn btn btn-outline-secondary mb-3"
              value="BukaBantuan (Hubungi Kami)"
            />
            <input
              type="button"
              className="btn helper btn btn-outline-secondary mb-3"
              value="FAQ (Tanya Jawab)"
            />
            <input
              type="button"
              className="btn helper btn btn-outline-secondary mb-3"
              value="Panduan Belanja"
            />
            <input
              type="button"
              className="btn helper btn btn-outline-secondary mb-3"
              value="Panduan Pelapak"
            />
            <input
              type="button"
              className="btn helper btn btn-outline-secondary mb-3"
          ...
          <div className="col-sm-2">
            ...
            <p style={{ fontSize: 12, marginBottom: "4px" }}>
              Beriklan di BukaIklan
            </p>
          </div>
          <div className="col-sm-3">
            <p style={{ fontSize: 12, marginBottom: "4px" }}>
              Lebih mudah dan hemat di aplikasi Bukalapak. Masukkan nomor
              handphone kamu untuk mendapatkan aplikasi Bukalapak.
            </p>
            <input
              type="text"
        ...
        <div className="row ml-2 mb-5 mb-0">
          <p style={{ fontSize: 12, marginBottom: "4px" }}>
            ...
            <span style={{ color: "red" }}>
              Arsip Mobile Site Peta Situs Liputan 6
            </span>{" "}
          </p>
        </div>
      </div>
